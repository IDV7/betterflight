...
void pid_init(flight_pids_t *drone_pids){
    ...
    pid_controller_init(&drone_pids->pid.yaw_pid, (float).4, (float)0.3, (float)0.3, (float)0.05, -750, 750, 1000, 2000);
    pid_controller_init(&drone_pids->pid.roll_pid, (float).4, (float)0.3, (float)0.3, (float)0.05, -750, 750, 1000, 2000);
    pid_controller_init(&drone_pids->pid.pitch_pid, (float).4, (float)0.3, (float)0.3, (float)0.05, -750, 750, 1000, 2000);
