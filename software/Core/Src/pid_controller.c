...
void get_set_points( drone_pids_t *drone_pids){
    LOGD("Set points (in get_set_points before): %f jaw, %f roll, %f pitch", drone_pids->set_points.yaw_set_point.set_point, drone_pids->set_points.roll_set_point.set_point, drone_pids->set_points.pitch_set_point.set_point);
    ...
    LOGD("Set points (in get_set_points after): %f jaw, %f roll, %f pitch", drone_pids->set_points.yaw_set_point.set_point, drone_pids->set_points.roll_set_point.set_point, drone_pids->set_points.pitch_set_point.set_point);
}
...
void test_pid_controller(void){
    ...
    limits_init(&drone_pids.set_points.yaw_set_point, 0, 150);
    limits_init(&drone_pids.set_points.roll_set_point, 0, 150);
    limits_init(&drone_pids.set_points.pitch_set_point, 0, 150);
